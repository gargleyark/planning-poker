          ...
          <div className="c-footer">
              ...
              <div className="layout_item w-50">
                <div className="newsletter">
                  <h3 className="newsletter_title">
                    "Voting is as much an emotional act as it is an intellectual
                    one."
                  </h3>
                  <div className="small ">- Monica Crowley</div>
                </div>
              </div>
              ...
              <div className="layout_item w-25">
                <nav className="c-nav-tool">
                  ...
                  <ul className="c-nav-tool_list">
                    <li>
                      <a href="https://gargleyark.com" className="c-link">
                        Gargleyark.com
                      </a>
                    </li>
                    ...
                    <li>
                      <a
                        href="https://cultofjeffgoldblum.com"
                        className="c-link"
                      >
                        Cult of Jeff
                      </a>
                    ...
                    <li>
                      <a
                        href="https://github.com/gargleyark"
                        className="c-link"
                      >
                        Github
                      </a>
            ...
            <div className="layout c-2">
              ...
              <div className="layout_item w-25">
                <ul className="flex">
                  <li>
                    <a href="https://www.github.com/gargleyark">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24"
                        width="32"
                  ...
                  <li>
                    <a href="https://www.google.com/gargleyark">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24"
                        width="32"
                  ...
                  <li>
                    <a href="https://www.instagram.com/gargleyark">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24"
                        width="32"
              ...
              <div
                className="layout_item w-25 pointer"
                style={{
                  display: 'flex',
                  justifyContent: 'end',
                  alignItems: 'center',
